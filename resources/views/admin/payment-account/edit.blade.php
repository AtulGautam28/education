            ...
            <div class="card-body">
                <form action="{{ route('admin.payment-account.update',$paymentAccount->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">{{ $websiteLang->where('lang_key','currency_rate')->first()->custom_text }} ({{ $websiteLang->where('lang_key','per')->first()->custom_text }} {{ $setting->currency_name }})</label>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.mollie-update', $mollie->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('lang_key','mollie')->first()->custom_text }}</label>
...
<div class="row d-none">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('lang_key','bank')->first()->custom_text }}</h6>
            </div>
            <div class="card-body">
