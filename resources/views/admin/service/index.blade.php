...
@section('admin-content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.service-image') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','bg_img')->first()->custom_text }}</label>
                        <div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $feature_image->title }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" class="form-control" cols="30" rows="5">{{ $feature_image->description }}</textarea>
                        </div>
                    </div>
