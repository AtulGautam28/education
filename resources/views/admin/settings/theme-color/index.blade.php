                ...
                <div class="card-body">
                    <form action="{{ route('admin.theme-color.update') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="theme_color_one">{{ $websiteLang->where('lang_key','color_one')->first()->custom_text }} : </label>
                            <input type="color" id="theme_color_one" name="theme_one" value="{{ $setting->theme_one }}">
                        </div>
                        <div class="form-group">
                            <label for="theme_color_two">{{ $websiteLang->where('lang_key','color_two')->first()->custom_text }} : </label>
