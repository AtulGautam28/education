                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings.update',$setting->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','current_header')->first()->custom_text }}</label>
                            @if ($setting->logo)
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','header_logo')->first()->custom_text }}</label>
                            <div><input type="file" name="logo" class="form-control"></div>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','current_footer')->first()->custom_text }}</label>
                            @if ($setting->footer_logo)
                            <div><img src="{{ url($setting->footer_logo) }}" alt="logo" class="w_200"></div>
                            @endif
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','footer_logo')->first()->custom_text }}</label>
